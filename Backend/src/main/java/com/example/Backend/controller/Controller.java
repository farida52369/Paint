...
/*
 ...
 $http GET http://localhost:8080/paint/shapes OR
 $http GET :8080/paint/shapes
 $http GET :8080/paint/undo
 $http GET :8080/paint/redo
 $http GET :8080/paint/save
 $http GET :8080/paint/load
 $http POST :8080/paint/shape < data.json
 LET'S ASSUME YOU HAVE A FILE NAMED data.json WHICH HAS THE EMPLOYEE DATA
 $touch data.json
 $vim data.json -- PASTE IN THE TEXT EDITOR THE SHAPES DATA
 $ http PUT :8080/paint/move < data.json
 $ http DELETE :8080/paint/delete/1
